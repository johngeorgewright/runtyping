import { array, check, custom, type InferOutput, intersect, is, length, minLength, object, optional, pipe, record, string, undefined as Undefined, union, unknown } from 'valibot';
