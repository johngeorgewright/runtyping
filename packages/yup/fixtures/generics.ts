...
export const B = <T extends string,>(T: Schema<T>,) => object({ type: T, }).defined();
...
export const D = <T extends number,>(T: Schema<T>,) => object({ type: T, }).defined();
...
export const F = <T extends InferType<typeof E>,>(T: Schema<T>,) => object({ type: T, }).defined();

export type F<T extends E> = InferType<ReturnType<typeof F<T>>>;

export const G = object({ abc: A(object({ data: string(), }).defined(),), }).defined();

export type G = InferType<typeof G>;

export const Test = <T extends any,>(T: Schema<T>,) => T.concat(object({ count: number(), }).defined()).defined();

export type Test<T> = InferType<ReturnType<typeof Test<T>>>;

export const Foo = object({ abc: Test(object({ data: string(), }).defined(),), }).defined();
