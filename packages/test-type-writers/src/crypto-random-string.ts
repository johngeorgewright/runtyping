...
const readUInt16LE = (uInt8Array: Int8Array, offset: number) =>
...
const createGenerator =
  (
    generateForCustomCharacters: any,
    specialRandomBytes: any,
    randomBytes: any
  ) =>
...
function createStringGenerator(
  ...
  randomBytes: (byteLength: number) => any
) {
