import { array, infer as Infer, lazy, literal, null as Null, number, object, record, string, undefined as Undefined, ZodType } from 'zod';
...
export type JSONSchema7Definition = Infer<typeof JSONSchema7Definition>;
...
export type JSONSchema7TypeName = Infer<typeof JSONSchema7TypeName>;

export const JSONSchema7Object: ZodType<_JSONSchema7Object> = lazy(() => record(string(), JSONSchema7Type));

export type JSONSchema7Object = Infer<typeof JSONSchema7Object>;

export const JSONSchema7Array: ZodType<_JSONSchema7Array> = lazy(() => array(JSONSchema7Type));

export type JSONSchema7Array = Infer<typeof JSONSchema7Array>;
