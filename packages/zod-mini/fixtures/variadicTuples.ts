...
export const A = array(Any()).check(
  minLength(1),
...
export const B = array(Any()).check(
  minLength(2),
  superRefine((data, ctx) => {
    pipeIssues(safeParse, {
      ctx,
...
export const C = array(Any()).check(
  minLength(1),
  superRefine((data, ctx) => {
    pipeIssues(safeParse, {
      ctx,
...
export const D = array(Any()).check(
  minLength(2),
  superRefine((data, ctx) => {
    pipeIssues(safeParse, {
      ctx,
...
export const E = array(Any()).check(
  minLength(5),
  superRefine((data, ctx) => {
    pipeIssues(safeParse, {
      ctx,
