...
import { any as Any, array, boolean, minLength, number, safeParse, string, superRefine } from 'zod/mini';
import { pipeIssues } from '@runtyping/zod-mini';

// This file is generated by runtyping (https://github.com/johngeorgewright/runtyping).
// Manual changes might be lost - proceed with caution!
export const A = array(Any()).check(minLength(1), superRefine((data, ctx) => {
...
export const B = array(Any()).check(minLength(2), superRefine((data, ctx) => {
  pipeIssues(safeParse, {
    ctx,
    data: data[0],
    path: 0,
...
export const C = array(Any()).check(minLength(1), superRefine((data, ctx) => {
  pipeIssues(safeParse, {
    ctx,
    data: data.slice(0, -1),
...
export const D = array(Any()).check(minLength(2), superRefine((data, ctx) => {
  pipeIssues(safeParse, {
    ctx,
    data: data[0],
    path: 0,
...
export const E = array(Any()).check(minLength(5), superRefine((data, ctx) => {
  pipeIssues(safeParse, {
    ctx,
    data: data[0],
    path: 0,
