import { any as Any, array, minLength, object, optional, type output, record, safeParse, string, superRefine, undefined as Undefined, union, unknown as Unknown } from 'zod/mini';
